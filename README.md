...
## 🎮 How to Play
1. Land on the animated welcome screen and hit **Proceed to Puzzles**.
2. Slide tiles into the empty slot (marked with a red dot) to rebuild the poster.
3. Use the **reference image on the right** to guide you.
...
├── js/game.js # Puzzle logic
└── images/ # Event posters & logo